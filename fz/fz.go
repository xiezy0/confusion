...
func main() {
	...
	pk := PrivKeysStr{}
	pk.Keys = append(pk.Keys,"6e74ca23d718de3b502a6c9d440aed843214e805a57363f3ec904e0265eb0c07")
	pk.Keys = append(pk.Keys,"6e74ca23d718de3b502a6c9d440aed843214e805a57363f3ec904e0265eb0c07")
	pk.Keys = append(pk.Keys,"b9a83257165b82a80f8a110bca071bad7c8cd466cd8756b6c192f161b9b86235")
	pk.Keys = append(pk.Keys,"33650cc9c3833ec45414a358d68b378808c5e30bfce16261ae0dc992b7bacbff")
	pk.Keys = append(pk.Keys,"ca43adbf35aa2d1a25ba21dda545d6299f767e6639f4738069c49a9add952484")

	//keyfile, _ := ioutil.ReadFile("pubkeys.json")
	rn := RingStr{}
	pub0 := PubKeyStr{"ce746180d535e6537f5e76c5990c6f31d5fd9bc9a391af845359553c7c4aab0a","184a81ce1e9c35ea0532a56cd33cec86d34d0cd47ec83b77ab06826ef1c24cba"}
	pub1 := PubKeyStr{"140624dfdb416b40701cc1ea391935210c5e04548837e6117af36dfda92fef1c","2329d2e0c4c0d2330b5841b8bfdd869595e816afb559f6737b0f67881a97fcfa"}
    pub2 := PubKeyStr{"a51eac7603860e4a8c93befedca343662a63e8381ded3f057ab8562bbe7ad68c","3d803b3ba3266515158b19120915b166e444d4c6bfd5a47bde816f1bbd0717db"}
	pub3 := PubKeyStr{"ce2c2b9ffc2733e5063fb7ddb50ec20808724524d2aed0d6a7c6affd64c3abe7", "d0ab8c3fe9638940c22232495c9308dbcbef2b42eecfe4f4f30602918afed41a"}
	rn.PubKeys = append(rn.PubKeys, pub0)
	rn.PubKeys = append(rn.PubKeys, pub1)
	rn.PubKeys = append(rn.PubKeys, pub2)
	rn.PubKeys = append(rn.PubKeys, pub3)
